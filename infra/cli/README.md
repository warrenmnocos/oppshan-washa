...
bash infra/cli/seed-secrets.sh     # 2. push the 7 values into SSM
...
This deletes the secret values in SSM along with everything else. Re-seed with `seed-secrets.sh`
