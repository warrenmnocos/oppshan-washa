...
SSM_PARAM_PATHS=(
  ...
  "${SSM_PREFIX}/QUARKUS_FLYWAY_JDBC_URL"
  "${SSM_PREFIX}/QUARKUS_FLYWAY_USERNAME"
  "${SSM_PREFIX}/QUARKUS_FLYWAY_PASSWORD"
)
LAMBDA_ENV_VARS=(
  "GOOGLE_CLIENT_ID"
  ...
  "QUARKUS_FLYWAY_JDBC_URL"
  "QUARKUS_FLYWAY_USERNAME"
  "QUARKUS_FLYWAY_PASSWORD"
)
ENV_SOURCE_KEYS=(
  "GOOGLE_CLIENT_ID"
  "GOOGLE_CLIENT_SECRET"
...
PARAM_TYPES=(
  ...
  "String"         # QUARKUS_FLYWAY_JDBC_URL (direct/non-pooled endpoint; non-secret)
  "String"         # QUARKUS_FLYWAY_USERNAME (washa_admin)
  "SecureString"   # QUARKUS_FLYWAY_PASSWORD
)
